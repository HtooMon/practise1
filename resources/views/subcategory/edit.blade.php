...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('SubCategory Edit') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ url('subcategory/'.$subcategories->id) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{$subcategories->name}}" required autofocus>
